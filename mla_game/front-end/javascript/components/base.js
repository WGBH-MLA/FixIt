        ...
        <div>
          ...
          >
            <button className='modal-close' onClick={this.closeModal}>
              ...
              <h1>About FIX IT</h1>
              <p>We need you to help ensure that public media always remains public&mdash;not just today’s broadcasts, but the archive all the way back to the beginning.</p>
              ...
              <p>Help us preserve history for future generations. Your corrections will be made available in public media’s largest digital archive at <a href="americanarchive.org" target="_blank">americanarchive.org</a></p>
