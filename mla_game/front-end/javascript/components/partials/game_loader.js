...
render(){
    ...
    // set message and icon for everygame
    ...
    if(gameNumber === 1) {
      ...
      gameSpecificData = <div><dt>Validated corrections</dt><dd>{gameData.validated_corrections}</dd></div>
    }
    ...
    return(
      <div className="grid loading-screen">
        <div className="loading-area">
          {this.props.loading ? (
            <svg className='loading-game-animation' viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        ...
        <dl className="loading-stats">
          <div>
            <dt>Total number of transcripts</dt>
            <dd>{gameData.total_number_of_transcripts}</dd>          
          </div>
          <div>
            <dt>Total transcripts fixed</dt>
            <dd>{gameData.total_fixed}</dd>
          </div>
          <div>
            <dt>Transcripts in progress</dt>
            <dd>{gameData.transcripts_in_progress}</dd>
          </div>
          <div>
            <dt>Total number of players</dt>
            <dd>{gameData.total_number_of_players}</dd>
          </div>
            {gameSpecificData}
        </dl>
      </div>
