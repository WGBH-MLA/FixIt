...
class MainNav extends React.Component {
  ...
  navState(){
    let staticMenu = this.props.version === 'staticMenu'
    if(staticMenu) {
  ...
  render() {
    let navState = classNames({
      'app-navigation': true,
      'open':this.props.navOpen,
    })
    return(
      <ul className={navState}>
        <li><Link onClick={() => this.closeNav()} activeClassName="active" to="leaderboard">
        ...
        <li><Link onClick={() => this.closeNav()} activeClassName="active" to="/" onlyActiveOnIndex>
            <svg className='nav-icon' viewBox="0 0 200 200">
        ...
        <li><Link onClick={() => this.closeNav()} activeClassName="active" to="preferences">
          <svg className="nav-icon" viewBox="0 0 200 200">
